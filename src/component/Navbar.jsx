      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-sm lg:text-base font-medium">
            <a
              href="/"
              className="text-[#2F327D] hover:text-[#F48C06] transition-colors relative group"
            >
              Home
            ...
            <div className="relative group">
              <button className="text-[#2F327D] hover:text-[#F48C06] transition-colors flex items-center gap-1 py-2">
                Study Abroad
                <svg
              ...
              {/* Mega Menu Panel */}
              <div className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-[1100px] max-w-[95vw] bg-white rounded-2xl shadow-2xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 overflow-hidden">
                <div className="flex">
            ...
            <a
              href="/contact"
              className="text-[#2F327D] hover:text-[#F48C06] transition-colors relative group whitespace-nowrap"
            >
              Contact Us
              <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-[#F48C06] group-hover:w-full transition-all duration-300"></span>
            </a>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t bg-white max-h-[80vh] overflow-y-auto">
            <div className="flex flex-col divide-y divide-gray-100 text-[15px] font-medium">
              <a href="/" className="py-4 px-5 text-[#2F327D]">
                Home
              </a>
              <a href="/about" className="py-4 px-5 text-[#2F327D]">
                About
              </a>
              ...
              <div>
                <button
                  className="w-full flex justify-between items-center py-4 px-5 text-[#2F327D]"
                ...
                {isStudyAbroadOpen && (
                  <div className="bg-gray-50 pb-3">
                    ...
                    {/* Tests & Exams - WITH TOOLTIPS */}
                    <p className="px-5 pt-4 pb-1 text-[11px] font-semibold tracking-wider text-gray-400 uppercase">
                      Tests & Exams
                    </p>

                    {/* English Language Tests */}
                    <p className="px-8 pt-2 pb-1 text-[11px] font-medium text-gray-500">
                      English Language Tests
                    </p>
                    {englishTests.map((test) => (
                      <a
                    ...
                    <p className="px-8 pt-3 pb-1 text-[11px] font-medium text-gray-500">
                      Foreign Language Tests
                    </p>
                    {foreignTests.map((test) => (
                      <a
              ...
              <a href="/blog" className="py-4 px-5 text-[#2F327D]">
                Our Blog
              </a>
              <a href="/services" className="py-4 px-5 text-[#2F327D]">
                Services
              </a>
              <a href="/contact" className="py-4 px-5 text-[#2F327D]">
                Contact Us
              </a>
            </div>
          </div>
