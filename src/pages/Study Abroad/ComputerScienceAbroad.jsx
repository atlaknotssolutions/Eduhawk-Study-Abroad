...
const ComputerScienceAbroad = () => {
  ...
  const stats = [
    { label: "Programs", value: "B.Tech, B.Sc, M.Sc, MS, M.Tech in CS & related fields" },
    { label: "Countries", value: "USA, Canada, UK, Germany, Australia, Ireland & more" },
  ...
  const features = [
    {
      ...
      desc: "We match your academic profile, preferred specialisation (AI, Data Science, Cybersecurity, Software Engineering etc.) and budget with universities that have strong industry links and placement records.",
    ...
    },
    {
      ...
      desc: "Practical support for IELTS/PTE, Statement of Purpose, Letters of Recommendation, resume and technical interview preparation.",
      color: "bg-blue-50 text-blue-600",
    },
    {
      title: "Honest destination comparison",
      desc: "Compare USA, Canada, UK, Germany, Australia and more on tuition, job market, post-study work rights and long-term career outcomes.",
      color: "bg-teal-50 text-teal-600",
    },
  ];

  const eligibility = [
    "Class 12 with PCM / Computer Science with required percentage (for Bachelor’s)",
    "Relevant Bachelor’s degree in Computer Science, IT, Software Engineering or related field (for Master’s)",
    ...
    "Coding projects, internships or GitHub profile preferred for competitive programs",
  ];
  ...
  const processSteps = [
    ...
    },
    {
      ...
      desc: "Help with accommodation, flights, banking and settling into campus and tech ecosystem.",
    },
  ];

  const faqs = [
    {
      q: "Which country is best for Computer Science abroad?",
      a: "USA and Canada lead for tech jobs and innovation. UK and Ireland are strong for Europe-based opportunities. Germany offers excellent value with low tuition. Australia has good post-study work rights. The best choice depends on your budget, specialisation and long-term plans.",
    },
    {
      q: "How much does it cost to study Computer Science abroad?",
      a: "Costs vary widely. Germany can be very affordable. Canada, UK, USA and Australia are more expensive. We provide a clear country-wise cost estimate covering tuition + living expenses before you apply.",
    },
    {
      q: "Do I need coding experience or projects?",
      a: "For Bachelor’s it is helpful but not always mandatory. For Master’s programs (especially competitive ones), projects, internships, GitHub or research experience significantly strengthen your application.",
    },
    {
      q: "Can I work while studying Computer Science?",
      a: "Yes. Most popular destinations allow 20 hours/week part-time work during term and full-time during holidays (subject to visa rules). Many students also do internships and co-op programs.",
    },
    {
      q: "When should I start the process?",
      a: "Ideally 9–12 months before your intended intake. This gives enough time for tests, shortlisting, applications and visa processing.",
    },
  ];
    ...
    <div className="font-sans text-slate-800 bg-white min-h-screen antialiased">
      ...
      <section className="relative h-[520px] md:h-[580px] flex items-center overflow-hidden">
        <img
          ...
          alt="Computer Science coding and technology"
        ...
        <div className="relative max-w-6xl mx-auto px-6 w-full">
          <div className="text-sm text-white/60 mb-5">
            ...
            <span className="mx-1.5">›</span> Computer Science
          </div>
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-xl mb-8 leading-relaxed">
            Top universities, strong tech ecosystems, industry exposure and
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-9">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
              Computer Science Abroad at a glance
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4">
                Computer Science Abroad with EduHawk
              </h2>
              <p className="text-slate-500 text-[15px] leading-relaxed mb-4">
                Computer Science remains one of the most in-demand and
                high-paying fields globally. Studying abroad gives you access to
                cutting-edge curriculum in Artificial Intelligence, Machine
                Learning, Data Science, Cybersecurity, Cloud Computing, Software
                Engineering and more.
              </p>
              <p className="text-slate-500 text-[15px] leading-relaxed mb-4">
                Universities in the USA, Canada, UK, Germany and Australia
                combine strong academic foundations with practical projects,
                industry collaborations and excellent career opportunities in
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-slate-900/80 to-transparent p-5">
                <p className="text-white text-sm font-medium">
                  AI · Data Science · Software Engineering · Cybersecurity
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="absolute inset-0 bg-slate-900/55 flex items-center justify-center">
              <div className="text-center text-white px-6">
                ...
                <p className="text-white/85 max-w-lg mx-auto">
                  From AI and cloud computing to cybersecurity and full-stack
                  development — build a future-ready tech career.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20" id="destinations">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
              Popular destinations for Computer Science
            </h2>
          </div>
          ...
          <p className="text-slate-500 text-[15px] leading-relaxed mt-5 max-w-xl">
            We help you compare tuition fees, living costs, tech job market,
...
export default ComputerScienceAbroad;