...
const MbbsAbroad = () => {
  ...
  const stats = [
    { label: "Destinations", value: "15+ countries and global study options" },
    { label: "Courses", value: "Bachelor’s, Master’s, MBBS and PhD pathways" },
    { label: "Support", value: "Complete guidance from profile to arrival" },
    { label: "Approach", value: "Personalised, transparent and practical" },
  ];

  const features = [
    {
      title: "Right university for your goals",
      desc: "We compare accreditation, curriculum, outcomes, location and entry requirements before recommending a university.",
    ...
    },
    {
      ...
      desc: "Compare UK, Canada, Australia, Germany, USA, Ireland, France, UAE and more by cost, career outcomes and lifestyle.",
      color: "bg-teal-50 text-teal-600",
    },
  ];

  const eligibility = [
    "Academic qualifications that match your selected course and university",
    "English language score such as IELTS, PTE or TOEFL where required",
    ...
    "A realistic study plan that connects your course with your future goals",
  ];
  ...
  const destinations = [
    ...
    { name: "United States", highlight: false },
  ...
  const processSteps = [
    ...
    },
    {
      ...
      desc: "Based on your profile, budget and preference we shortlist suitable courses and universities.",
    },
    {
      step: 3,
  ...
  const faqs = [
    {
      ...
      a: "There is no single best country. The right choice depends on your course, budget, academic profile, career plans, work rules and preferred lifestyle.",
    },
    {
      q: "How much does it cost to study abroad?",
      a: "Costs vary by country, course and university. Your budget includes tuition, accommodation, living expenses, insurance, travel and visa costs. We share a realistic estimate before you apply.",
    },
    {
      q: "Do I need IELTS or another English test?",
      a: "Many universities ask for IELTS, PTE, TOEFL or an accepted alternative, although some offer waivers based on your previous education. Requirements are checked university by university.",
    },
    {
      q: "Can I get a scholarship?",
      a: "Scholarships may be merit-based, university-specific or linked to a particular country. We help identify suitable opportunities and prepare your application.",
    },
    {
      q: "When should I start my application?",
      a: "Starting 6 to 12 months before your intended intake gives you time for testing, shortlisting, documents, applications and visa preparation.",
    },
  ];
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white pt-16 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-sm text-white/50 mb-5">
            ...
            <span className="mx-1.5">›</span> MBBS Abroad
          </div>
          ...
          <p className="text-base sm:text-lg text-white/70 max-w-xl mb-8 leading-relaxed">
            NMC-recognised universities, transparent fees, safe campuses and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4">
                MBBS Abroad with Eduhawk
              </h2>
              <p className="text-slate-500 text-[15px] leading-relaxed mb-3.5">
                Thousands of Indian students choose MBBS abroad every year
                because of limited seats and high competition in India. The
                right university, country and support system make all the
                difference.
              </p>
              <p className="text-slate-500 text-[15px] leading-relaxed mb-5">
                Eduhawk helps you choose only NMC-eligible universities,
                understand real costs, and complete the entire admission + visa
                process with transparency. We focus on long-term outcomes — not
                just getting you a seat.
              </p>
              <a
                href="#consult"
            ...
            <div className="relative bg-gradient-to-br from-blue-600 to-sky-500 rounded-[20px] p-10 text-white text-center min-h-[280px] flex flex-col justify-end items-center">
              ...
              <div className="text-5xl font-bold leading-none">15–40L</div>
              <div className="text-[15px] opacity-90 mt-1.5">
                Approx. total budget range
              </div>
              <div className="mt-6 text-sm opacity-80">
                Transparent fees · NMC focused
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-slate-900 text-white rounded-2xl p-8">
              ...
              <p className="text-white/70 text-[15px] leading-relaxed mb-5">
                Share your Class 12 marks and NEET details. We will tell you
                honestly which countries and universities are realistic for your
                profile and budget.
              </p>
              <a
                href="#consult"
      ...
      <section className="py-16 sm:py-20" id="destinations">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-slate-500 text-[15px] leading-relaxed mt-5 max-w-xl">
            ...
            and NMC recognition so you can choose the right country — not just
            the cheapest one.
          </p>
        </div>
      </section>
