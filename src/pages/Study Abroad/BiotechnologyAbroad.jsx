...
const BiotechnologyAbroad = () => {
  ...
  const stats = [
    { label: "Programs", value: "B.Tech, M.Sc, M.Tech, MS & PhD in Biotechnology" },
    { label: "Countries", value: "Germany, Canada, UK, USA, Australia, Ireland & more" },
    { label: "Support", value: "Complete end-to-end guidance from profile to arrival" },
    { label: "Approach", value: "Research-focused · Transparent fees · Honest counselling" },
  ];

  const features = [
    {
      title: "Right university for your goals",
      desc: "We carefully match your academic background, research interest and budget with universities that have strong biotech labs, industry collaborations and good career outcomes.",
    ...
    },
    {
      ...
      desc: "From shortlisting and SOP writing to applications, research proposals, scholarships and visa documentation — we stay with you throughout the process.",
    ...
    },
    {
      ...
      desc: "Practical support for IELTS/PTE, Statement of Purpose, Letters of Recommendation, research experience and interview preparation.",
      color: "bg-blue-50 text-blue-600",
    },
    {
      title: "Honest destination comparison",
      desc: "Compare Germany, Canada, UK, USA, Australia and more on research quality, tuition, post-study work rights and industry exposure.",
      color: "bg-teal-50 text-teal-600",
    },
  ];

  const eligibility = [
    "Class 12 with PCB / PCM / Biotechnology with required percentage (for Bachelor’s)",
    "Relevant Bachelor’s degree in Biotechnology, Life Sciences, Microbiology, Biochemistry etc. (for Master’s)",
    ...
    "Research experience or projects preferred for Master’s & PhD applications",
  ];
  ...
  const processSteps = [
    {
      ...
      desc: "Share your academics, research interest, preferred countries and budget. We give an honest assessment of realistic options.",
    },
    {
      step: 2,
      title: "University & course shortlisting",
      desc: "We shortlist universities with strong biotechnology departments, research facilities and good industry or academic outcomes.",
    },
    {
      step: 3,
      title: "Application & offer",
      desc: "Full support with applications, SOP, LORs, research statements, documents and scholarship opportunities until you receive offers.",
    },
    {
      step: 4,
      title: "Visa guidance",
    ...
    },
    {
      ...
      desc: "Help with accommodation, flights, banking and settling into campus and research life.",
    },
  ];

  const faqs = [
    {
      q: "Which country is best for Biotechnology abroad?",
      a: "Germany is excellent for research-focused programs and low tuition. Canada and Australia offer strong industry exposure and post-study work rights. USA and UK lead in research intensity and rankings. The best choice depends on whether you prefer research, industry jobs or higher studies.",
    },
    {
      q: "How much does it cost to study Biotechnology abroad?",
      a: "Costs vary significantly. Germany can be very affordable. Canada, UK, USA and Australia are more expensive. We provide a clear country-wise cost estimate covering tuition + living expenses before you apply.",
    },
    {
      q: "Do I need research experience for Master’s in Biotechnology?",
      a: "It is not mandatory everywhere, but research projects, internships or publications significantly strengthen your application — especially for competitive universities in Germany, USA and UK.",
    },
    {
      q: "Can I work while studying Biotechnology?",
    ...
    },
    {
      ...
      a: "Ideally 9–12 months before your intended intake. This gives enough time for tests, shortlisting, research proposals, applications and visa processing.",
    },
  ];
    ...
    <div className="font-sans text-slate-800 bg-white min-h-screen antialiased">
      ...
      <section className="relative h-[520px] md:h-[580px] flex items-center overflow-hidden">
        <img
          ...
          alt="Biotechnology research lab"
        ...
        <div className="relative max-w-6xl mx-auto px-6 w-full">
          <div className="text-sm text-white/60 mb-5">
            ...
            <span className="mx-1.5">›</span> Biotechnology
          </div>
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-xl mb-8 leading-relaxed">
            Advanced research labs, strong industry connections, transparent
            fees and complete end-to-end support — from admission to
            pre-departure. Honest guidance by EduHawk.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-9">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
              Biotechnology Abroad at a glance
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4">
                Biotechnology Abroad with EduHawk
              </h2>
              <p className="text-slate-500 text-[15px] leading-relaxed mb-4">
                Biotechnology is one of the fastest-growing fields globally,
                combining biology with technology to create solutions in
                healthcare, agriculture, pharmaceuticals, environmental science
                and industrial processes.
              </p>
              <p className="text-slate-500 text-[15px] leading-relaxed mb-4">
                Studying Biotechnology abroad gives you access to advanced
                research laboratories, experienced faculty, industry
                collaborations and strong career pathways in research,
                biopharma, diagnostics and innovation-driven companies.
              </p>
              <p className="text-slate-500 text-[15px] leading-relaxed mb-6">
                EduHawk helps you choose the right country and university based
                on your academic profile, research interest and budget — with
      ...
      <section className="py-10">
        <div className="max-w-6xl mx-auto px-6">
          <div className="relative rounded-2xl overflow-hidden h-[280px] md:h-[340px]">
            <img
              src="https://images.unsplash.com/photo-1581093458791-9d42e3c7e584?q=80&w=2070&auto=format&fit=crop"
            ...
            <div className="absolute inset-0 bg-slate-900/55 flex items-center justify-center">
              <div className="text-center text-white px-6">
                ...
                <p className="text-white/85 max-w-lg mx-auto">
                  From genetic engineering to biopharmaceuticals — build a
                  future at the intersection of biology and technology.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-slate-900 text-white rounded-2xl p-8">
              ...
              <p className="text-white/70 text-[15px] leading-relaxed mb-5">
                Share your Class 12 / bachelor’s marks, research interest and
      ...
      <section className="py-16 sm:py-20" id="destinations">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
              Popular destinations for Biotechnology
            </h2>
          </div>
          ...
          <p className="text-slate-500 text-[15px] leading-relaxed mt-5 max-w-xl">
            We help you compare research quality, tuition fees, living costs,
            post-study work rights and industry exposure so you choose the right
            country — not just the most popular one.
          </p>
        </div>
      </section>
...
export default BiotechnologyAbroad;