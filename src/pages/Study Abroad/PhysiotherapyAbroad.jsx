...
const PhysiotherapyAbroad = () => {
  ...
  const stats = [
    { label: "Programs", value: "BPT, MPT, DPT & related physiotherapy courses" },
  ...
  const features = [
    {
      ...
      desc: "We compare accreditation, clinical exposure, curriculum, ranking and entry requirements before recommending a university.",
    ...
    },
    {
      ...
      desc: "Compare UK, Canada, Australia, USA, Ireland, New Zealand and more by cost, clinical exposure, licensing and lifestyle.",
      color: "bg-teal-50 text-teal-600",
    },
  ];

  const eligibility = [
    "Class 12 with PCB (Physics, Chemistry, Biology) with minimum required percentage",
    ...
    "A realistic study plan that connects your physiotherapy course with your future goals",
  ];
  ...
  const processSteps = [
    ...
    },
    {
      ...
      desc: "Based on your profile, budget and preference we shortlist suitable physiotherapy courses and universities.",
    },
    {
      step: 3,
  ...
  const faqs = [
    {
      q: "Which country is best for Physiotherapy abroad?",
      a: "There is no single best country. The right choice depends on your budget, academic profile, preferred course (BPT / MPT / DPT), clinical exposure and long-term licensing plans. UK, Canada, Australia and Ireland are currently the most popular among Indian students.",
    },
    {
      q: "How much does it cost to study Physiotherapy abroad?",
    ...
    {
      q: "Can I work while studying Physiotherapy abroad?",
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white pt-16 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-sm text-white/50 mb-5">
            ...
            <span className="mx-1.5">›</span> Physiotherapy
          </div>
          ...
          <p className="text-base sm:text-lg text-white/70 max-w-xl mb-8 leading-relaxed">
            Top universities, strong clinical exposure, transparent fees and
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-9">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
              Physiotherapy Abroad at a glance
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4">
                Physiotherapy Abroad with EduHawk
              </h2>
              <p className="text-slate-500 text-[15px] leading-relaxed mb-3.5">
                Studying Physiotherapy abroad gives you access to advanced
                clinical training, modern rehabilitation techniques and strong
                global career opportunities in hospitals, sports, private
            ...
            <div className="relative bg-gradient-to-br from-blue-600 to-sky-500 rounded-[20px] p-10 text-white text-center min-h-[280px] flex flex-col justify-end items-center">
              <div className="absolute top-5 left-5 bg-white/15 backdrop-blur-sm px-3.5 py-2 rounded-lg text-[13px] font-semibold">
                EduHawk · Physiotherapy Abroad
              </div>
              <div className="text-5xl font-bold leading-none">18–42L</div>
      ...
      <section className="py-16 sm:py-20" id="destinations">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
              Popular destinations for Physiotherapy
            </h2>
          </div>
          ...
          <p className="text-slate-500 text-[15px] leading-relaxed mt-5 max-w-xl">
            ...
            clinical exposure and career pathways so you can choose the right
            country — not just the cheapest one.
          </p>
        </div>
      </section>
...
export default PhysiotherapyAbroad;